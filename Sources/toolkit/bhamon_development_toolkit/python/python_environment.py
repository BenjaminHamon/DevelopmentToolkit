...
class PythonEnvironment:
    ...
    def __init__(self, system_python_executable: str, venv_directory: str, extra_package_repository: Optional[str] = None) -> None:
        self._system_python_executable = system_python_executable
        self._venv_directory = venv_directory
        self._extra_package_repository = extra_package_repository
    ...
    def setup_virtual_environment(self, simulate: bool = False) -> None:
    ...
    def install_python_packages(self,
        ...
        if self._extra_package_repository is not None:
            install_command.add_arguments([ "--extra-index", self._extra_package_repository ])
