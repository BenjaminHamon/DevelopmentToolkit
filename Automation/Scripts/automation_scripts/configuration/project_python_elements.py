...
class ProjectPythonElements:


    def __init__(self, package_collection: List[PythonPackage]) -> None:
        self.package_collection = package_collection


    def get_python_package_metadata(self, project_metadata: ProjectMetadata) -> PythonPackageMetadata:
